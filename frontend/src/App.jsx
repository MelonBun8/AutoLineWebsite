...
import DeliveryLettersList from './features/deliveryletters/DeliveryLettersList'
...
import EditDeliveryLetter from './features/deliveryletters/EditDeliveryLetter'
import NewDealReportForm from './features/dealreports/NewDealReportForm'
import NewDeliveryLetterForm from './features/deliveryletters/NewDeliveryLetterForm'
            ...
            <Route element = {<RequireAuth allowedRoles={[...Object.values(ROLES)]} />}> 
              <Route element = {<Prefetch />}>  
                <Route path = "dash" element = {<DashLayout />} > 
                  ...
                  <Route path = "delivery-letters" > {/*This will be the path for "XYZ.com/dash/deal-reports" */}
                    <Route index element = {<DeliveryLettersList />} />
                    <Route path = ':id' element = {<EditDeliveryLetter />} />
                    <Route path = 'new' element = {<NewDeliveryLetterForm />} />
                  </Route>
